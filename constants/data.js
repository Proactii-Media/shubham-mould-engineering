...
const products = [
...

  {
    title: "Automated Assembly",
    description:
      "It primarily automates the pen assembly process, significantly reducing the need for manual labor."
  },
  {
    title: "Integrated Feeding System",
    description:
      "The machine features overhead containers (hoppers) designed for feeding pen parts and executing the assembly process."
  }
    ...
    description:
        "The Semi-Automatic Pen Assembly Machine (2-up/4-up ) is designed to streamline the production process by efficiently joining various pen components. By automating the assembly phase, this machine significantly reduces manual labor, enhances production speed, and ensures consistent quality control.",

    specifications: {
        "Machine Type": "Semi Automatic Assembly Machine",
        "Assembly Mode": "2up Chain carry, Horizintal Typ",
...
{
    id: 16,
    title: "Refill Assembly Machine (SME-R-09) 2up",
    slug: "refill-assembly-machine-sme-r-09",
...
keyFeatures: [
  {
    title: "Functions",
    description:
      "The machine primarily automates the pen assembly process, significantly reducing the need for manual labor. It features overhead containers (hoppers) for feeding parts and executing the assembly process."
  },
  {
    title: "High Precision Refill Assembly",
    description:
      "The machine performs refill assembly operations with accurate component positioning to maintain consistent assembly quality."
  },
  {
  ...
  },
  {
    ...
    description:
      "Built with durable industrial components to provide reliable performance and long-term machine service life."
  }
],
    description:
    ...
    specifications: {
        "Machine Type": "Refill Assembly Machine (SME-R-09)",
        "Assembly Mode": "2up Chain carry, Horizintal Туре",
        "Workefficiency": "70-80 pcs/min",
        "Suitable Diameter": "4-8mm",
        "Suitable leanth": "60-200mm",
        "Touch Screen": "7",
...
{
  id: 6,
  title: "Oil Spout Cap / Cap Clip Assembly Machine 2UP",
 ...
 bannerImage: "/shubhamimages/banner/product_banner/17.png",
  ...
  specifications: {
    "Machine Type": "Spout Cap Assembly Machine",
     "Assembly Mode ": "Indexing, Vertical Type",
      "Workefficiency": "35-40 pcs/min",
